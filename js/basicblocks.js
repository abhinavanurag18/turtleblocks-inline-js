...
function initBasicProtoBlocks(palettes, blocks) {
    ...
    var alertBlock = new ProtoBlock('alert');
    alertBlock.palette = palettes.dict['turtle1'];
    blocks.protoBlockDict['alert'] = alertBlock;
    alertBlock.staticLabels.push(_('alert'));
    alertBlock.adjustWidthToLabel();
    alertBlock.oneArgBlock();

    var varBlock = new ProtoBlock('var');
    varBlock.palette = palettes.dict['turtle1'];
    blocks.protoBlockDict['var'] = varBlock;
    varBlock.staticLabels.push(_('var'));
    varBlock.adjustWidthToLabel();
    varBlock.oneArgBlock();

    var varnameBlock = new ProtoBlock('varname');
    varnameBlock.palette = palettes.dict['turtle1'];
    blocks.protoBlockDict['varname'] = varnameBlock;
    varnameBlock.staticLabels.push(_('a'));
    varnameBlock.adjustWidthToLabel();
    varnameBlock.parameterBlock();
    
    var assignBlock = new ProtoBlock('assign');
    assignBlock.palette = palettes.dict['turtle1'];
    blocks.protoBlockDict['assign'] = assignBlock;
    assignBlock.staticLabels.push(_('='));
    assignBlock.adjustWidthToLabel();
    assignBlock.twoArgBlock();
    assignBlock.dockTypes[1] = 'anyin';
    assignBlock.dockTypes[2] = 'anyin';
