...
function Logo(canvas, blocks, turtles, stage, refreshCanvas, textMsg, errorMsg,hideMsgs, onStopTurtle, onRunTurtle, prepareExport, getStageX,getStageY, getStageMouseDown, getCurrentKeyCode,clearCurrentKeyCode, meSpeak, saveLocally){
    ...
    this.runFromBlockNow = function(logo, turtle, blk) {
        ...
        switch (logo.blocks.blockList[blk].name) {
            ...
            //abhinav : add the functionality here
            case 'alert' :
                if (args.length == 1) {
            ...
            case 'var' :
                ...
                // var varname = logo.parseArg(logo, turtle, cblk, blk);
                // this.boxes['a'].value = 0;
                break;
            case 'assign' :
                if (args.length == 2) {
